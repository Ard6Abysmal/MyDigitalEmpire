    ...
    return (
      <div className={`min-h-screen flex items-center justify-center ${
        ...
        <div className="text-center">
          ...
          <p className={isDark ? 'text-empire-text' : 'text-light-text'}>Loading blog posts...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className={`text-xl max-w-3xl mx-auto leading-relaxed ${
            ...
            Documenting my journey through AI/ML computer vision, neuromorphic VLSI design, embedded IoT systems, and full-stack development — 
            ...
            <div className="relative z-10 flex justify-center gap-3 flex-wrap">
              {categories.map((cat, idx) => (
                <motion.button
                  ...
                  className={`relative px-5 py-2.5 rounded-xl font-bold flex items-center gap-2 border-2 shadow-lg overflow-hidden transition-all ${
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {posts.map((post, idx) => (
            <Link key={post.id} to={`/blog/${post.slug}`}>
              <div
                className={`blog-card relative rounded-2xl overflow-hidden border-2 shadow-xl h-full flex flex-col transition-all duration-200 ${
                  isDark 
        ...
        {posts.length === 0 && (
          <motion.div
            ...
            className={`blog-card relative text-center py-20 px-6 rounded-2xl border-2 shadow-xl overflow-hidden transition-all duration-200 ${
              isDark 
        ...
        {posts.length > 0 && (
          <motion.div
            ...
            className={`blog-card relative mt-16 p-8 rounded-2xl border-2 text-center shadow-xl overflow-hidden transition-all duration-200 ${
              isDark 
        ...
        <motion.div
          ...
          className={`blog-card relative mt-16 p-10 rounded-2xl border-2 text-center shadow-2xl overflow-hidden transition-all duration-200 ${
            isDark 
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className={`text-lg leading-relaxed max-w-3xl mx-auto mb-6 ${
              ...
              I regularly share insights on <span className="font-bold text-empire-cyan">AI/ML computer vision</span> (BlueDepth-Crescent), 
              <span className="font-bold text-empire-green"> embedded IoT systems</span>, 
              <span className="font-bold text-empire-purple"> neuromorphic VLSI design</span>, and{' '}
              <span className="font-bold text-empire-orange">full-stack development</span>. 
              Follow my journey as I build, learn, and innovate in hardware-software integration.
            </p>
            <div className="flex gap-4 justify-center flex-wrap">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                transition={{ duration: 0.2, ease: "easeOut" }}
                className="relative px-6 py-3 rounded-xl bg-gradient-to-r from-empire-purple to-empire-cyan text-white font-bold shadow-lg hover:shadow-[0_0_30px_rgba(168,85,247,0.6)] transition-all inline-flex items-center gap-2 overflow-hidden"
              >
