...
import { ArrowLeft, Github, ExternalLink, Calendar, Tag, Zap, Award, Code, Sparkles } from 'lucide-react';
    ...
    return (
      <div className={`min-h-screen flex items-center justify-center ${
        ...
        >
          ...
          <motion.p
            className="text-empire-purple text-sm mt-2"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
    ...
    <div className={`relative min-h-screen pt-24 pb-16 ${
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-6">
        ...
        >
          <Link 
            to="/projects"
            className="inline-flex items-center gap-2 text-empire-purple hover:text-empire-cyan transition-all duration-300 mb-8 group font-bold text-base md:text-lg"
          >
        ...
        <motion.div
          ...
          className={`project-block relative p-6 md:p-8 rounded-2xl border-2 shadow-2xl mb-12 overflow-hidden transition-all duration-300 ${
            isDark 
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              <span className={`px-3 md:px-4 py-2 rounded-lg text-xs md:text-sm font-bold border-2 transition-all ${
                isDark 
                  ? 'bg-dark-bg border-empire-purple/40 text-empire-text hover:border-empire-purple/60' 
                  : 'bg-light-bg border-empire-purple/30 text-light-text hover:border-empire-purple/50'
              }`}>
                {project.category}
              </span>
              <span className={`px-3 md:px-4 py-2 rounded-lg text-xs md:text-sm font-bold border-2 transition-all ${
                project.status === 'In Development' || project.status === 'Active Development'
                  ? 'bg-empire-green/25 text-empire-green border-empire-green/50 hover:bg-empire-green/35'
                  : project.status === 'Planned' || project.status === 'Research Phase'
                    ? 'bg-empire-orange/25 text-empire-orange border-empire-orange/50 hover:bg-empire-orange/35'
                    : project.status === 'Completed'
                      ? 'bg-empire-cyan/25 text-empire-cyan border-empire-cyan/50 hover:bg-empire-cyan/35'
                      : 'bg-empire-purple/25 text-empire-purple border-empire-purple/50 hover:bg-empire-purple/35'
              }`}>
                {project.status}
              </span>
            </motion.div>
            ...
            >
              {project.github_url && (
                <motion.button
                  ...
                  className="btn-glow relative flex items-center gap-2 px-5 md:px-6 py-3 rounded-xl bg-gradient-to-r from-empire-purple to-purple-600 text-white font-bold shadow-lg hover:shadow-[0_0_30px_rgba(168,85,247,0.6)] transition-all overflow-hidden"
                >
                  <Github size={20} />
              ...
              {project.live_url && (
                <motion.button
                  ...
                  className="btn-glow relative flex items-center gap-2 px-5 md:px-6 py-3 rounded-xl bg-gradient-to-r from-empire-cyan to-blue-600 text-white font-bold shadow-lg hover:shadow-[0_0_30px_rgba(6,182,212,0.6)] transition-all overflow-hidden"
                >
        ...
        <motion.div
          ...
          className={`project-block relative p-6 md:p-8 rounded-2xl border-2 shadow-xl mb-12 overflow-hidden transition-all duration-300 ${
            isDark 
              ...
              {(Array.isArray(project.tech) ? project.tech : [project.tech]).map((tech, i) => {
                ...
                return (
                  <motion.span
                    ...
                    className={`flex items-center gap-2 px-3 md:px-4 py-2 rounded-lg border-2 font-bold shadow-md transition-all cursor-default ${
                      isDark
                        ? 'bg-empire-purple/20 text-empire-purple border-empire-purple/40 hover:bg-empire-purple/30 hover:border-empire-purple/60 hover:shadow-empire-purple/30'
                        : 'bg-empire-purple/15 text-empire-purple border-empire-purple/30 hover:bg-empire-purple/25 hover:border-empire-purple/50 hover:shadow-empire-purple/20'
                    }`}
                  >
                    <TechIcon className="w-4 h-4 md:w-5 md:h-5" />
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-12">
          ...
          {project.features && project.features.length > 0 && (
            <motion.div
              ...
              className={`project-block relative p-6 md:p-8 rounded-2xl border-2 shadow-xl overflow-hidden transition-all duration-300 ${
                isDark 
              ...
              <div className="relative z-10">
                ...
                <ul className="space-y-3">
                  {project.features.map((feature, i) => (
                    ...
                    >
                      <motion.span 
                        className="text-empire-green font-bold text-lg mt-0.5"
                        animate={{ scale: [1, 1.2, 1] }}
        ...
        {project.full_description && (
          ...
          >
            ...
            <div className="relative z-10">
              ...
              >
                <p className="font-semibold text-base md:text-lg">{project.full_description}</p>
              </div>
            </div>
          </motion.div>
        )}
            ...
            <div className="grid md:grid-cols-3 gap-4 md:gap-6">
              {relatedProjects.map((relatedProject, index) => (
                ...
                >
                  ...
                  >
                    <div
                      className={`project-block relative rounded-xl overflow-hidden border-2 shadow-xl h-full transition-all duration-300 ${
                        isDark 
                    ...
                    >
                      ...
                      <div className="p-6 relative z-10">
                        <div className="flex items-center justify-between mb-3 gap-2">
                          <span className="text-xs px-2 md:px-3 py-1.5 rounded-lg bg-empire-cyan/20 text-empire-cyan border-2 border-empire-cyan/40 font-bold">
                            {relatedProject.category}
                          </span>
                          <span className={`text-xs px-2 md:px-3 py-1.5 rounded-lg font-bold border-2 ${
                        ...
                        <h3 className={`text-lg md:text-xl font-black mb-2 line-clamp-2 ${
                          isDark ? 'text-empire-text' : 'text-light-text'
                        }`}>
                          {relatedProject.name}
                        </h3>
        ...
        <motion.div
          ...
          className={`project-block relative mt-16 p-8 md:p-10 rounded-2xl border-2 text-center shadow-2xl overflow-hidden transition-all duration-300 ${
            isDark 
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className={`text-base md:text-lg leading-relaxed max-w-2xl mx-auto mb-6 ${
              ...
              <span className="font-bold text-empire-cyan">Amal Madhu</span> is always open to discussing innovative projects in{' '}
              ...
              <span className="font-semibold text-empire-orange">embedded systems</span>, or{' '}
